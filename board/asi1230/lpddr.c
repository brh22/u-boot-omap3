...
#if 0
	/* output DRAM settings for use in .gel script */
	printf("EMIF_TIM1 = 0x0%08x\n", EMIF_TIM1);
	printf("EMIF_TIM2 = 0x0%08x\n", EMIF_TIM2);
	printf("EMIF_TIM3 = 0x0%08x\n", EMIF_TIM3);
	printf("EMIF_REF_CTRL = 0x0%08x\n", EMIF_REF_CTRL);
	printf("EMIF_SDRAM_CONFIG = 0x0%08x\n", EMIF_SDRAM_CONFIG);
	printf("EMIF_SDRAM_CONFIG2 = 0x0%08x\n", EMIF_SDRAM_CONFIG2);
	printf("EMIF_SDRAM_ZQCR = 0x0%08x\n", EMIF_SDRAM_ZQCR);
#endif

void config_asi1230_lpddr(void)
{
	int macro, emif;
	...
	__raw_writel(EMIF_REF_CTRL | DDR_EMIF_REF_TRIGGER,
